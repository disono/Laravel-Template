...
include_once 'Vendor/ecommerce.php';
...
if (!function_exists('db_filter_id')) {
    ...
    {
        return App\Disono\Helpers\WBDatabase::filterID($data, $column_name);
    }
}
...
if (!function_exists('paginate')) {
    ...
    {
        return App\Disono\Helpers\WBDatabase::paginate($collections, $pagination_num);
    }
}
...
if (!function_exists('exclude_slug')) {
    ...
    {
        return App\Disono\Helpers\WBDatabase::excludeSlug();
    }
}
...
if (!function_exists('success_json_response')) {
    ...
    {
        return App\Disono\Helpers\WBHttp::successJSONResponse($data, $links, $pagination, $extra);
    }
}
...
if (!function_exists('failed_json_response')) {
    ...
    {
        return App\Disono\Helpers\WBHttp::failedJSONResponse($errors, $status);
    }
}
...
if (!function_exists('download_image')) {
    ...
    {
        return App\Disono\Helpers\WBHttp::downloadImage($file_name, $url, $quality);
    }
}
...
if (!function_exists('get_ip_address')) {
    ...
    {
        return App\Disono\Helpers\WBHttp::ip();
    }
}
...
if (!function_exists('get_user_agent')) {
    ...
    {
        return App\Disono\Helpers\WBHttp::userAgent();
    }
}
...
if (!function_exists('node_connector')) {
    ...
    {
        return App\Disono\Helpers\WBHttp::NodeJSConnector($path);
    }
}
...
if (!function_exists('socket_emit')) {
    ...
    {
        App\Disono\Helpers\WBHttp::SocketIOEmit($name, $data, $uri);
    }
}
...
if (!function_exists('fcm_send')) {
    ...
    {
        return App\Disono\Helpers\WBHttp::FCMSend($token, $title, $body, $sound);
    }
}
...
if (!function_exists('fcm_topic')) {
    ...
    {
        return App\Disono\Helpers\WBHttp::FCMTopic($topic_name, $title, $body, $sound);
    }
}
...
if (!function_exists('delete_file')) {
    ...
    {
        return App\Disono\Helpers\WBFile::delete($path);
    }
}
...
if (!function_exists('filename_creator')) {
    ...
    {
        return App\Disono\Helpers\WBFile::filenameCreator();
    }
}
...
if (!function_exists('error_logger')) {
    ...
    {
        App\Disono\Helpers\WBFile::errorLogger($message);
    }
}
...
if (!function_exists('get_image')) {
    ...
    {
        return App\Disono\Helpers\WBFile::getImg($source, $type, $path_only);
    }
}
...
if (!function_exists('encode_base64_image')) {
    ...
    {
        return App\Disono\Helpers\WBFile::encodeBASE64Image($filename, $filetype);
    }
}
...
if (!function_exists('upload_any_file')) {
    ...
    {
        return App\Disono\Helpers\WBFile::uploadFile($file, $destinationPath, $old_file);
    }
}
...
if (!function_exists('upload_image')) {
    ...
    {
        return App\Disono\Helpers\WBFile::uploadImage($file, $image_options, $old_file, $destinationPath, $nameOnly);
    }
}
...
if (!function_exists('create_folder')) {
    ...
    {
        return App\Disono\Helpers\WBFile::createFolder($path);
    }
}
...
if (!function_exists('money')) {
    ...
    {
        return App\Disono\Helpers\WBFormat::money($number, $sign);
    }
}
...
if (!function_exists('app_settings')) {
    ...
    {
        return App\Disono\Helpers\WBConfig::settings($key);
    }
}
...
if (!function_exists('app_header')) {
    ...
    {
        return App\Disono\Helpers\WBConfig::header($get_header);
    }
}
...
if (!function_exists('config_per_page')) {
    ...
    {
        return App\Disono\Helpers\WBConfig::perPage();
    }
}
...
if (!function_exists('config_file_size')) {
    ...
    {
        return App\Disono\Helpers\WBConfig::fileSize($type);
    }
}
...
if (!function_exists('config_img_quality')) {
    ...
    {
        return App\Disono\Helpers\WBConfig::imageQuality($file_size, $quality);
    }
}
...
if (!function_exists('config_min_age')) {
    ...
    {
        return App\Disono\Helpers\WBConfig::minAge();
    }
}
...
if (!function_exists('config_max_age')) {
    ...
    {
        return App\Disono\Helpers\WBConfig::maxAge();
    }
}
...
if (!function_exists('sql_date')) {
    ...
    {
        return App\Disono\Helpers\WBDate::sqlDate($date, $date_only);
    }
}
...
if (!function_exists('sql_time')) {
    ...
    {
        return App\Disono\Helpers\WBDate::sqlTime($date);
    }
}
...
if (!function_exists('human_date')) {
    ...
    {
        return App\Disono\Helpers\WBDate::humanDate($date, $date_only);
    }
}
...
if (!function_exists('human_time')) {
    ...
    {
        return App\Disono\Helpers\WBDate::humanTime($time);
    }
}
...
if (!function_exists('date_formatting')) {
    ...
    {
        return App\Disono\Helpers\WBDate::formatDate($date);
    }
}
...
if (!function_exists('expired_at')) {
    ...
    {
        return App\Disono\Helpers\WBDate::expiredAt($minute);
    }
}
...
if (!function_exists('count_years')) {
    ...
    {
        return App\Disono\Helpers\WBDate::countYears($then, $current);
    }
}
...
if (!function_exists('count_hours')) {
    ...
    {
        return App\Disono\Helpers\WBDate::countHours($start, $end);
    }
}
...
if (!function_exists('theme')) {
    ...
    {
        return App\Disono\Helpers\WBView::theme($file, $data);
    }
}
...
if (!function_exists('current_theme')) {
    ...
    {
        return App\Disono\Helpers\WBView::current_theme();
    }
}
...
if (!function_exists('admin_view')) {
    ...
    {
        return App\Disono\Helpers\WBView::admin_view($file, $data);
    }
}
...
if (!function_exists('url_ext')) {
    ...
    function url_ext()
    {
        return App\Disono\Helpers\WBUrl::randomURLExtension();
    }
}
...
if (!function_exists('url_title')) {
    ...
    {
        return App\Disono\Helpers\WBUrl::urlTitle($str, $separator, $lowercase);
    }
}
...
if (!function_exists('profile_url')) {
    ...
    {
        return App\Disono\Helpers\WBUrl::profileUrl($id);
    }
}
...
if (!function_exists('active_url')) {
    ...
    {
        return App\Disono\Helpers\WBUrl::activeUrl($url);
    }
}
...
if (!function_exists('me')) {
    ...
    function me()
    {
        return App\Disono\Helpers\WBAuth::authUser();
    }
}
...
if (!function_exists('authorize_me')) {
    ...
    {
        return App\Disono\Helpers\WBAuth::authorizeMe($roles, $user_id, $route_check);
    }
}
...
if (!function_exists('authorize_route')) {
    ...
    {
        return App\Disono\Helpers\WBAuth::authorizeRoute($user_id, $abort);
    }
}
...
if (!function_exists('api_auth')) {
    ...
    {
        return App\Disono\Helpers\WBAuth::APICheckAuth($input_name);
    }
}
...
if (!function_exists('api_auth_jwt')) {
    ...
    {
        return App\Disono\Helpers\WBAuth::APIAuthenticateJWT($response);
    }
}
...
if (!function_exists('init_token_key')) {
    ...
    {
        App\Disono\Helpers\WBAuth::initializeTokenKey();
    }
}
...
if (!function_exists('resource_authorize')) {
    ...
    {
        return App\Disono\Helpers\WBAuth::resourceAuthorize($user);
    }
}
...
if (!function_exists('sendSMS')) {
    ...
    {
        return App\Disono\Helpers\WBMessaging::SMS($number, $message);
    }
}
...
if (!function_exists('dpf_modify')) {
    function dpf_modify()
    {
        return \App\Disono\Helpers\WBPDF::modify();
    }
}