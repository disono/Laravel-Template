    ...
    <div class="container-fluid shadow-sm p-3 bg-white">
        <div class="row">
            <div class="col">
                ...
                <div class="row mt-3">
                    <div class="col">
                        <form action="{{ route('admin.socketIoNotification.update') }}" method="post"
                              v-on:submit.prevent="onFormUpload">
                            {{ csrf_field() }}

                            <input type="hidden" value="{{ $socket_notification->id }}" name="id">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-12 mb-3">
                                    ...
                                    <input id="title" type="text"
                                           ...
                                           name="title" value="{{ old('title', $socket_notification->title) }}"
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-12 mb-3">
                                    ...
                                    <textarea name="content" id="content" rows="3" data-validate="required"
                                              class="form-control{{ hasInputError($errors, 'content') }}">{{ old('content', $socket_notification->content) }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-12 mb-3">
                                    ...
                                    <select name="type" id="type" class="form-control select_picker"
                                        ...
                                        <option value="topic" {{ $socket_notification->type == 'topic' ? 'selected' : '' }}>
                                            Topic
                                        </option>
                                        <option value="token" {{ $socket_notification->type == 'token' ? 'selected' : '' }}>
                                            Token
                                        </option>
                                    </select>
                            ...
                            <div class="row" v-if="frmAdminIO.type == 'topic'">
                                <div class="col-md-4 col-sm-12 mb-3">
                                    ...
                                    <input id="topic_name" type="text"
                                           ...
                                           name="topic_name" value="{{ old('topic_name', $socket_notification->topic_name) }}"
                                           data-validate="required"
                                           v-model="frmAdminIO.topic_name">
                            ...
                            <div class="row" v-if="frmAdminIO.type == 'token'">
                                <div class="col-md-4 col-sm-12 mb-3">
                                    ...
                                    <input id="token" type="text"
                                           ...
                                           name="token" value="{{ old('token', $socket_notification->token) }}"
                                           data-validate="required"
                                           v-model="frmAdminIO.token">
