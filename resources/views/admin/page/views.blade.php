    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 col-md-12">
                <h3 class="page-header">Pages Views</h3>
                ...
                <div class="app-container">
                    <form action="" method="get" role="form" class="form-inline">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control date-picker-none" name="date_range_from" id="date_range_from"
                                   value="{{$request->get('date_range_from')}}" placeholder="From Date">
                        </div>

                        <div class="form-group">
                            <input type="text" class="form-control date-picker-none" name="date_range_to" id="date_range_to"
