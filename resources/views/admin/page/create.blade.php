    ...
    <div class="container-fluid shadow-sm p-3 bg-white">
        <div class="row">
            <div class="col">
                ...
                <div class="row mt-3">
                    <div class="col">
                        <form action="{{ route('admin.page.store') }}" method="post" v-on:submit.prevent="onFormUpload">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="col-md-9 col-sm-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="content" id="content"
                                                  ...
                                                  data-validate="required">{!! old('content') !!}</textarea>
                                ...
                                <div class="col-md-3 col-sm-12 mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="/assets/img/placeholders/default.png" alt="Cover Photo"
                                             id="_cover_photo"
                                    ...
                                    <div class="form-group">
                                        <label class="custom-control material-checkbox">
                                            <input type="checkbox" class="material-control-input"
                                                   value="1"
                                                   name="is_draft" {{ frmIsChecked('is_draft', 1) }}>
                                    ...
                                    <div class="form-group">
                                        <label class="custom-control material-checkbox">
                                            <input type="checkbox" class="material-control-input"
                                                   value="1"
                                                   name="is_email_to_subscriber" {{ frmIsChecked('is_email_to_subscriber', 1) }}>
                                            <span class="material-control-indicator"></span>
                                    ...
                                    <div class="collapse border-0 p-0" id="collapseSEOAttributes">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="seo_description" id="seo_description"
                                                      class="form-control"
                                                      rows="3"
                                                      data-validate="max:300">{!! old('seo_description') !!}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="seo_robots" type="text"
                                                   ...
                                                   name="seo_robots" value="{{ old('seo_robots') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="og_description" id="og_description"
                                                      class="form-control"
                                                      rows="3"
                                                      data-validate="max:300">{!! old('og_description') !!}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="/assets/img/placeholders/default.png" alt="og:image"
                                                 id="_og_image"
                                                 class="rounded shadow-sm img-fluid"
                                    ...
                                    <hr>
                                    <button type="submit" class="btn btn-raised btn-primary">Create new page</button>
                                </div>
                            </div>
                        </form>
                    </div>
